...
package com.ahmetcan.yolov5_opencv;
...
//        CompoundButton.OnCheckedChangeListener,
  ...
  protected void setFragment() {
    ...
    Fragment fragment;
    if (useCamera2API) {
      com.ahmetcan.yolov5_opencv.CameraConnectionFragment camera2Fragment =
          com.ahmetcan.yolov5_opencv.CameraConnectionFragment.newInstance(
              new com.ahmetcan.yolov5_opencv.CameraConnectionFragment.ConnectionCallback() {
                @Override
